...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa-brands fa-wizards-of-the-coast"></i>CreativeGames
			</h3>
		</div>
		<div class="col-md-6">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="all_latest_game.jsp"><i class="fa-solid fa-diamond"></i>Latest
					Games</a></li>
			<li class="nav-item active"><a class="nav-link disabled"
				href="all_old_game.jsp"><i class="fa-solid fa-diamond"></i>Old
					Games</a>
			<li class="nav-item active"><a class="nav-link disabled"
				href="all_upcoming_game.jsp"><i class="fa-solid fa-diamond"></i>Upcoming
					Games</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
